...
namespace INTRO_USERS
{
    public partial class BrowsePage : Form
    {
        ...
        private void buttonSearch_Click(object sender, EventArgs e)
        {
            ...
            //*YOUR CODE HERE*
            //Query to get the data we want from a table using username and ID
            query = "SELECT * FROM UserSession WHERE UserName LIKE \'" + username + "\' AND SocMediaID LIKE \'" + socialMediaID + "'"; 
            //The SQL select query, using above
            ...
            try
            {
                ...
                if (SQL.read.HasRows)
                {
                    ...
                    while (SQL.read.Read())
                    {
                        ...
                        listBoxDisplay.Items.Add("Session ID: " + sessionID + ", Social Media: " + socialMediaID+ ", Session Time: " + sessionTime);
                    }
                }
                else // Where it doesn't have any successful searches
                {
